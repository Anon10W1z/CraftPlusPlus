...
public class RenderStoneBoat extends Render {
	private static final ResourceLocation boatTextures = new ResourceLocation("minecraft:textures/blocks/stone.png");
	protected ModelBase modelBoat = new ModelBoat();

	public RenderStoneBoat() {
	...
	public void doRender(Entity entity, double x, double y, double z, float f, float partialTicks) {
		EntityStoneBoat boat = (EntityStoneBoat) entity;
